  ...
  return (
    <div className=" max-w-7xl mx-auto p-6 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
          className="p-4 shadow-lg border-[#16F467] border rounded-lg hover:-translate-y-1 hover:shadow-[0_5px_10px_black]
        ...
        <div className="p-4 shadow-md border-[#16F467] border rounded-lg hover:-translate-y-1 hover:shadow-[0_5px_10px_black] hover:border-black transition duration-300">
          ...
          <p className=" text-2xl text-lime-500">{totalOrders}</p>
        ...
        <div className="p-4 shadow-md border-[#16F467] border rounded-lg hover:-translate-y-1 hover:shadow-[0_5px_10px_black] hover:border-black transition duration-300">
          ...
          <p className=" text-2xl text-lime-500">{products.length}</p>
            ...
            <tbody>
              {orders.length > 0 ? (
                orders.map((order) => (
                  <tr
                    key={order._id}
                    className=" border-b border-gray-300 hover:bg-gray-800 cursor-pointer"
                  >
