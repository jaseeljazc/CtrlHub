    ...
    <div className="min-h-screen bg-black text-white ">
      ...
      <section className="relative py-20 px-4 overflow-hidden ">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 left-1/4 w-40 h-40 border border-green-500 rounded-full"></div>
        </div>
      ...
      {/* <section className="py-16 px-4 bg-gradient-to-r from-black via-gray-900 to-black">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-green-500">Gaming by the Numbers</h2>
          <div className="grid md:grid-cols-4 gap-8">
            {stats.map((stat, index) => {
              const IconComponent = stat.icon;
              return (
                <div key={index} className="text-center group">
                  <div className="bg-green-500 bg-opacity-20 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-opacity-30 transition-all duration-300">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-violet-500 to-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/">
              <button className="bg-black text-green-500 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-900 transition-colors duration-300">
                Shop Gaming Gear
              </button>
            </Link>
            <Link to="/contact">
              <button className="border-2 border-black text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-black hover:text-green-500 transition-colors duration-300">
                Contact Us
              </button>
            </Link>
          </div>
